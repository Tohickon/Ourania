...
B2=(AspectPatternCheck PhaseCheck FittingHarnessCheck JoyCheck TransitCheck SynastryCheck ReturnsCheck TensionReleaseCheck HarmonicCheck HarmonicResonanceCheck)
...
n=$(run "com.zodiacomputing.ourania.gui.ChartSetupCheck")
